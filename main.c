...
void updateTimerLabel (Time time) {
	_updateTimerLabel(time, FALSE);
}

void updateTimerLabelFinal (Time time) {
	_updateTimerLabel(time, TRUE);
}
...
static void
appActivate (GApplication *app, gpointer user_data) {
	GtkWidget *win;
